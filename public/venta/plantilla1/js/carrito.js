    ...
    const actualizarInterfazCarrito=()=>{
        ...
        if(carrito.length <1){
            ...
            carrito.forEach((producto,index)=>{
                ...
                article.classList.add("carrito-producto_container")
                ...
                btnQuitarProducto.classList.add("carrito-boton_control","carrito-btnQuitar","fas","fa-trash-alt")
                ...
                btnSubirCan.classList.add("carrito-btnSubirCan","carrito-boton_control")
                ...
                btnBajarCan.classList.add("carrito-btnBajarCan","carrito-boton_control")
                ...
                productoContainer.classList.add("carrito-producto")
        
                carritoMain.appendChild(article)
        
                article.appendChild(fotoProducto)
                article.appendChild(productoContainer)
                productoContainer.appendChild(productoDetallesCon)
        
                productoDetallesCon.appendChild(spanNombre)
                productoDetallesCon.appendChild(spanPrecio)
        
                productoContainer.appendChild(carritoProductoControl)
